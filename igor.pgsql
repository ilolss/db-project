...
INSERT INTO project.orders (client_id, point_id, good_name, price) 
SELECT client_id, point_id, 'Электрическая зубная щетка Oral-B Genius 9000', 8999.00
FROM project.clients, project.points 
WHERE project.clients.phone_number = '8966123456' 
AND project.points.address = 'ул. Ленинская, д. 8';

INSERT INTO project.orders (client_id, point_id, good_name, price) 
SELECT client_id, point_id, 'Смарт-термометр Xiaomi Mi Temperature and Humidity Sensor', 1499.00
FROM project.clients, project.points 
WHERE project.clients.phone_number = '8976123456' 
AND project.points.address = 'пр. Гагарина, д. 5';
...
INSERT INTO project.orders (client_id, point_id, good_name, price) 
SELECT client_id, point_id, 'Беспроводные наушники Apple AirPods Pro', 24999.00
FROM project.clients, project.points 
WHERE project.clients.phone_number = '8905123456' 
AND project.points.address = 'ул. Пушкина, д. 1';
