-- Найти продавцов, у которых средний рейтинг их товаров ниже 3.
...
-- Найти самые дорогие товары каждого продавца.
...
-- Найти ПВЗ с рейтингом выше среднего по всем ПВЗ, отсортировать по рейтингу.
...
-- Вывести пункты выдачи заказов с количеством работников, отсортированные по убыванию количества работников.
